...
const soundsTable = [
  ...
  ['./count-sound/ato.mp3', './count-sound/san.mp3', './count-sound/juu-.mp3', './count-sound/byou.mp3'], // 30 sec
...
export const countSound = async (min: number, sec: number, start = false): Promise<void> => {
  if (start) {
